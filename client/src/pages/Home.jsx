...
const RenderCards=({data,title})=>{
  ...
  return <h2 className='mt-2 font-bold text-[#16469ff] text-xl uppercase' >{title}</h2>
}
    ...
    <section className='max-w-7xl mx-auto' >
      ...
      <div className='mt-10 ' >
        {loading?(<div className='flex justify-center items-center' >
          ...
          {searchText&& <h2 className='font-medium text-[#66e75] text-xl mb-3' >Showing Results for <span className='text-[#222328]' >{searchText}</span></h2>}
        </>)}
